            ...
            modelBuilder.Entity("E_commorec.core.Entity.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9acb4169-7651-4301-89aa-71edbcc42c6b"),
                            Email = "test1@gmail.com",
                            FirstTimeRegister = new DateTime(2024, 9, 5, 15, 51, 52, 864, DateTimeKind.Local).AddTicks(4055),
                            Gender = 0,
                            Name = "sadwa",
                            Phone = "098",
                            Study = "",
                        ...
                        new
                        {
                            Id = new Guid("f10acaa5-455a-4fd1-bcc9-63f5b7720bf4"),
                            Email = "test31@gmail.com",
                            FirstTimeRegister = new DateTime(2024, 9, 5, 15, 51, 52, 864, DateTimeKind.Local).AddTicks(5195),
                            Gender = 0,
                            Name = "asdgf",
                            Phone = "123123",
                            Study = "",
                        ...
                        new
                        {
                            Id = new Guid("73db973c-bdb6-49a1-ab8b-0792a807e015"),
                            Email = "test2@gmail.com",
                            FirstTimeRegister = new DateTime(2024, 9, 5, 15, 51, 52, 864, DateTimeKind.Local).AddTicks(5202),
                            Gender = 0,
                            Name = ",bvbnbn",
                            Phone = "098",
                            Study = "",
            ...
            modelBuilder.Entity("E_commorec.core.Entity.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f3f6e41e-5738-49ec-b2e6-1f2fedda010a"),
                            Email = "test1@gmail.com",
                            FirstTimeRegister = new DateTime(2024, 9, 5, 15, 51, 52, 865, DateTimeKind.Local).AddTicks(5788),
                            Gender = 0,
                            LevelOfStudy = "string",
                            Name = "sadwa",
                            Phone = "098",
                            Position = "stro",
                            TimeToResign = new DateTime(2024, 9, 5, 15, 51, 52, 865, DateTimeKind.Local).AddTicks(6859)
                        },
                        new
                        {
                            Id = new Guid("473f31d9-abd6-4cc4-ab60-deb1b8aee383"),
                            Email = "test2@gmail.com",
                            FirstTimeRegister = new DateTime(2024, 9, 5, 15, 51, 52, 865, DateTimeKind.Local).AddTicks(7085),
                            Gender = 0,
                            LevelOfStudy = "str2ing",
                            Name = "s1adwa",
                            Phone = "0981",
                            Position = "s3tro",
                            TimeToResign = new DateTime(2024, 9, 5, 15, 51, 52, 865, DateTimeKind.Local).AddTicks(7089)
                        });
                });
